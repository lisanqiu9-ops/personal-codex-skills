---
name: gongwen
description: Use when formatting or drafting Chinese official documents,申报材料,正式函件,报告,投标/揭榜申报书,Word DOCX documents, or when the user asks for gongwen、公文格式、公文写作规范、仿宋/黑体/楷体、首行缩进2字符、标题黑色、附件/落款/页码规范.
---
